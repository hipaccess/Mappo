	...
	var SearchBox = Backbone.View.extend({
		initialize: function(options) {
			...
			var markersLayer = new L.LayerGroup();	
	   		...
	   		this.map.addControl( new L.Control.Search({searchLayer: markersLayer}) );
		}
	});
	
	L.plugins.Search.addTo = function( map ) {
    	return new SearchBox( {map:map} );
  	};
